...
# Helper to sync joblib with tqdm
@contextmanager
...
# This will be called in each thread/process
...
# Main logic
def main():
    output_dir = "E:/Meliha-Patenti/output-joblib"
    ...
    with engine.connect() as conn:
        while True:
            ...
            meta_df.to_csv(f"{output_dir}/metadata_batch_{batch_num}.csv", index=False)
            np.save(f"{output_dir}/embeddings_batch_{batch_num}.npy", embed_matrix)
